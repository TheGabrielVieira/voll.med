...
import br.com.medvoll.domain.paciente.*;
...
public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemPaciente>> listarPaciente(@PageableDefault(size = 10, sort = {"name"})Pageable paginacao) {
